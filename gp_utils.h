...
double  gross_premium(double *pq_arr, int b_term, int p_term, int ad_num, int ci_num, int cid_num, double* benefit, double* benefit_gp, double *loading, double rate);
